...
export const env = {
  ...
  PENDING_REGISTRATION_TTL: process.env.PENDING_REGISTRATION_TTL ?? '24h',
  PENDING_REGISTRATION_TTL_MS: durationToMs(process.env.PENDING_REGISTRATION_TTL ?? '24h', 24 * 60 * 60 * 1000),
